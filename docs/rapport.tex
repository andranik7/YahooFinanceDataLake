...
Les scores de sentiment VADER (décrits en section~5) sont agrégés en moyenne quotidienne par symbole et fournis au modèle comme variable exogène. Les jours sans actualité reçoivent un score neutre de 0.0. Pour les jours futurs, la moyenne du sentiment des 30 derniers jours est utilisée comme hypothèse de projection.
...
Le dashboard principal présente trois visualisations :
